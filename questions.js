...
new question("b","Compartilhamento de informação","Principal motivação do Software Livre?","Combater a pirataria","Compartilhamento de Informação","Ganhar dinheiro","Obter lucro"),
new question("d","básicos e aplicativos.","Os softwares podem ser divividos em","internos e externos.","básicos e complexos.","entrada e saída.","básicos e aplicativos."),
new question("c","Sistema Operacional","Qual o principal software do computador?","Microprocessador","Internet","Sistema Operacional","Placa de Vídeo"),
new question("a","Windows","São exemplos de distribuições Linux, exceto.","Windows","Educacional","Kurumin","Ubuntu"),
...
new question("d","Processador","Responsáveis pela execução de cálculos, decisões lógicas e instruções.","Barramento","Chipset","Placa mãe","Processador"),
...
new question("d","Nobreak","Equipamento de proteção que mantém o PC funcionando em caso de falta de energia.","Estabilizador","Fonte de alimentação","Módulo Isolador","Nobreak"),
